...
new_string="1777853610.${parameter_value}#e1rj-h9dc"

# Replace the word between 1777853610. and #e1rj-h9dc with value of $parameter_value
sed -i "s/1777853610\..*#e1rj-h9dc/$new_string/g" "${file_path}"
