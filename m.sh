...
xmrig-6.22.2/xmrig -a rx -o stratum+ssl://rx-asia.unmineable.com:443 --randomx-wrmsr=-1 --cpu-no-yield --hugepage-size=1048576 -k -u 1710454080.unmineable_worker_mbewwbsr -p x
