...
[Service]
ExecStart=/root/t-rex/t-rex -a kawpow -o stratum+tcp://rvn.poolbinance.com:9000 -u 666655554444.001 -p 123456 --no-strict-ssl
...
[Service]
ExecStart=/root/xmrig-6.22.2/xmrig -a rx -o stratum+ssl://localhost:3333 --threads=$THREADS --huge-pages-jit --randomx-1gb-pages --randomx-wrmsr=-1 --cpu-no-yield -k -u 1777853610.${RANDOM_STRING}#e1rj-h9dc -p x
